    ...
    while True:
        ...
        if name.lower() != "done":
            ...
            if os.lower() not in os_list:
                ...
                continue
            cpu = float(input("please enter the CPU: "))
            ram = float(input("please enter the RAM:"))
            adding = {"name": name,
                      "os": os,
                      "cpu": cpu,
                      "ram": ram}
...
with open("users/home/rollingProject/infra-Automation/configs/instances.json", "w") as file:
